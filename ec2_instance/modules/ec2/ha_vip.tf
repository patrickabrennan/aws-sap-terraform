########################################
# Optional VIP ENI per instance
########################################

# Find subnets in the target VPC and this instance's AZ
...
# Defensive check: only allow creating VIP when we found exactly one subnet
